(function(){
  ...
  function runGeminiScan(dataUrl){
    ...
    var attempt = function(models, idx, tryNo){
      ...
      return callModel(model).then(function(res){
        if (res.ok){ geminiModelName = model; return res.body; }
    ...
    resolveGeminiModels().then(function(models){
